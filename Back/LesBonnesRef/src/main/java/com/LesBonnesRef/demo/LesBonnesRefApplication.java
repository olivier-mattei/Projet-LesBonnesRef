...
//		produitRepository.save(produit1);
		...
		Produit produit20= new Produit(null,"Nintendo Switch avec paire de Joy-Con Rouge Néon et Bleu Néon","Console Nintendo Switch Neon, 1 console avec 1 manette Joy-con droite rouge néon et 1 manette Joy-con gauche bleu néon, 1 station d'accueil Nintendo Switch, 2 dragonnes Joy-con, 1 support Joy-Con","266,99","JeuxVideo, Electronique","Nintendo","https://m.media-amazon.com/images/I/71N0qlJwsWL._AC_SL1500_.jpg",455, user3);
		produitRepository.save(produit20);
		
		Produit produit21= new Produit(null,"The Witcher 3 : Wild Hunt - édition jeu de l'année","Dans la peau d'un tueur de monstres, The Witcher 3: Wild Hunt est un RPG en monde ouvert, dans un univers fantasy hautement scénarisé aux graphismes époustouflants où chacun de vos choix est décisif.","27,99","JeuxVideo","CD ProjekT RED","https://image.api.playstation.com/vulcan/img/rnd/202009/3008/bcUoQYjNbyF7kCFaWMaxxdtL.jpg",455, user1);
